...
module.exports = {
    ...
    filterRules: {
        ...
        // IMPORTANT: Setting this to `true` will dramatically slow down filtering and increase the risk of rate-limiting.
        // The bot already handles users with closed DMs during the sending phase.
        // It is recommended to keep this `false` unless you have a very strong reason to pre-filter.
        preFilterCheckDMs: false,
        bioBlacklist: [
            'crypto',
            'NFT',
            'bitcoin',
        ...
        qualityScoreKeywords: [
            // Bonus points if bio contains these
            'sports', 'nba', 'nfl', 'football', 'basketball', 'soccer', 'fan', 'game', 'betting'
        ],
    },
